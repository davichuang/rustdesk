...
pub const RENDEZVOUS_SERVERS: &[&str] = &["home.davic.top"];
pub const PUBLIC_RS_PUB_KEY: &str = "Ang36406399hospital";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://home.davic.top:21114";
